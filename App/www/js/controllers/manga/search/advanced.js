angular.module('starter.manga.search.advanced', ['ion-autocomplete', 'starter.services.common', 'starter.services.japscan'])
    .controller('MangaSearchAdvancedCtrl', function($scope, $ionicPopup, serviceCommon, wsJapscan) {
    ...
    }).directive('tabsearchadvancedmangaTemplate', function() {
        return {
            templateUrl: 'templates/manga/search/advanced.html'
        };
    });